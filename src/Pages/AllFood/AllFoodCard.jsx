...
const AllFoodCard = ({ food }) => {
  ...
  return (
    <div data-aos="fade-up">
      <div className="max-[350px] overflow-x-hidden lg:hover:scale-105 transition mx-auto space-y-6 rounded-2xl bg-goldenM px-6 py-4 shadow-md dark:bg-[#18181B] md:w-[350px]">
        {/* Card Image */}
        <img
          height={190}
